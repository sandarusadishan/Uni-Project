...
const Cart = () => {
  ...
  const handleCheckout = () => {
    ...
    // Mock order creation with a delay to show loading state
    setTimeout(() => {
      const order = {
        id: `ORD${Date.now()}`,
        items,
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-background to-secondary">
        ...
        <div className="container flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4 py-10 mx-auto text-center animate-fadeInBlur">
          ...
          <Button onClick={() => navigate('/menu')} size="lg" className="gap-2 transition-transform duration-200 gold-glow hover:scale-105">
